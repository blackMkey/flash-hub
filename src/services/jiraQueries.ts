...
export const useTypeOfWork = (projectId: string | null, issueKey: string | null) => {
  return useQuery({
...
export const useDefectPatterns = (issueId: string | null, projectId: string | null) => {
  return useQuery({
...
export const useCreateSubtask = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      queryClient.invalidateQueries({ queryKey: ['epic', variables.parentKey] })
